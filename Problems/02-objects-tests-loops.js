...
function objectToSentence (obj) {
  let objectSentence= (obj.firstName + " " + obj.lastName + " was a " + obj.profession + ".");
...
function computeReign (pm) {
  let reign= (pm.fullName + "\'s reign was " + (pm.to-pm.from) + " years long.");
  return reign;
